...
pop_image = face.load_image_file("imgs/source/6319C10019-1.jpg")
pop_face_encoding = face.face_encodings(pop_image)[0]

# ใบหน้าคนที่ต้องการรู้จำเป็นreference #คนที่2
oat_image = face.load_image_file("imgs/source/6319C10019-1.jpg")
    ...
    if ret:
        ...
        if process_this_frame:
            ...
            for face_encoding in face_encodings:
                face_distances = face.face_distance(
        ...
        for (top, right, bottom, left), name, percent in zip(face_locations, face_names, face_percent):
            ...
            cv2.putText(frame, "MATCH: "+str(percent)+"%",
                        (left+6, bottom+23), font, 0.6, (255, 255, 255), 1)
